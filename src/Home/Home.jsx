						...
						<div className="Steps-cont" data-aos-duration="1200">
							<div data-aos="fade-right">
								<div className="Steps">
									<div>
										...
										<p>
											...
											platforms or official contact
											channels to express your interest in
											our products and discuss your
								...
								<div className="Steps">
									<div>
										...
										<p>
											...
											solutions, and propose the best
											option. Once we finalize the
											details, we will move forward with
											the order process.
										</p>
									</div>
									<div>
								...
								<div className="Steps">
									<div>
										<h1>
											Step 3: Placing the Order and Making
											a Deposit
										</h1>
										<br />
										<p>
											After confirming the solution, you
											will officially place your order and
											make the initial deposit, allowing
											us to initiate the production
											process as per the agreed
											specifications.
										</p>
									</div>
									<div>
							...
							<div data-aos="fade-left" data-aos-duration="1200">
								<div className="Steps">
									<div>
										...
										<p>
											...
											checks and multiple testing phases
											to ensure optimal performance before
											shipment.
										</p>
									</div>
									<div>
								...
								<div className="Steps">
									<div>
										<h1>
											Step 5: Packaging, Shipping, and
											Secure Delivery
										</h1>
										<br />
										<p>
											We carefully package each item to
											prevent damage during transit. We
											use secure shipping methods,
											including iron shelves, to optimize
											space and reduce transportation
											costs while ensuring safe delivery.
										</p>
									</div>
									<div>
								...
								<div className="Steps">
									<div>
										...
										<br />
										<p>
											Upon receiving your order, our
											technical team will guide you
											through installation and setup. We
											offer remote assistance via video
											calls or provide detailed
											instructional videos to ensure a
											smooth operation.
										</p>
									</div>
									<div>
